...
class ObstacleAvoidanceScenario(carla_base):
    ...
    def get_reward_v3(self, **states):
        ...
        # print(type(lateral_pos))
        # print(lateral_pos.shape)
        # print("lateral_pos:", lateral_pos)
        # ego_pos_x_pixel = int(lateral_pos * 100)  # 原语句
    ...
    def get_env_state(self):
        ...
        # print("obstacles_state：", obstacles_state)
    ...
    def vis_state_as_img(self, state):
        ...
        ## draw ego vehicle
        cv2.circle(img, (256 + ego_pos_x_pixel, ego_pos_y_pixel), color=(255, 255, 255),
